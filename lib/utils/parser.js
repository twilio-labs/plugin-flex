...
exports._validate = exports._trim = void 0;
 ...
 * @private
 */
exports._validate = (flags, options, parse) => {
...
const parser = (OclifParser) => (options, argv = []) => {
    const parse = OclifParser(options, argv);
    parse.flags = exports._trim(parse.flags);
    parse.args = exports._trim(parse.args);
    if (options && options.flags && parse.flags) {
        exports._validate(parse.flags, options.flags, parse);
    }
    return parse;
};
