...
export default class FlexPlugin extends baseCommands.TwilioClientCommand {
     ...
     * @param pkg
     */
    static getPackageVersion(pkg: string): any;
    /**
     ...
     */
    runScript(scriptName: string, argv?: string[]): Promise<any>;
    /**
     * Spawns a script
     * @param scriptName  the script to spawn
     * @param argv arguments to pass to the script
     */
    spawnScript(scriptName: string, argv?: string[]): Promise<import("flex-plugins-utils-spawn").SpawnReturn>;
    /**
